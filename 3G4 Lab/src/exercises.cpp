...
// glm::mat4 glm::rotate(glm::mat4 m, float angle, glm::vec3 axis)
// glm::mat4 glm::translate(glm::mat4 m, glm::vec3 v)
// (see the modelling transformation above for an example of using translate)
...
{
  surface_vertex_shader = GOURAUD_VERTEX;
  surface_fragment_shader = GOURAUD_FRAGMENT;
}
